...
func (c Context) EphemeralStore(key storetypes.StoreKey) ephemeral.EphemeralStore {
	return c.ms.GetEphemeralStore(key)
}

func (c Context) EphemeralKVStore(key storetypes.StoreKey) ephemeral.EphemeralKVStore {
	return c.ms.GetEphemeralKVStore(key)
}
